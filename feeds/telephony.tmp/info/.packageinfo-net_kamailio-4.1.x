...
Section: net
Category: Network
Title: Mature and flexible open source SIP server, v4.1.5
Maintainer: Jiri Slachta <slachta@cesnet.cz>
Source: kamailio-4.1.5_src.tar.gz
Type: ipkg
Description: Mature and flexible open source SIP server, v4.1.5
...
Package: kamailio4-mod-rtpproxy-ng
Submenu: Telephony
Version: 4.1.5-3
Depends: +libc +USE_EGLIBC:librt +USE_EGLIBC:libpthread kamailio4 +kamailio4-mod-tm
Menu-Depends: 
...
Section: net
Category: Network
Title: kamailio4 RTP proxy with new control protocol module
Maintainer: Jiri Slachta <slachta@cesnet.cz>
Source: kamailio-4.1.5_src.tar.gz
Type: ipkg
Description: kamailio4 RTP proxy with new control protocol module
http://www.kamailio.org/
Jiri Slachta <slachta@cesnet.cz>
@@
